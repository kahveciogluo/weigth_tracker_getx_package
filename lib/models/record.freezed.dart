...
class _$RecordTearOff {
  ...
  _Record call(
      {required int weigth, required DateTime dateTime, String? note}) {
    return _Record(
      weigth: weigth,
      dateTime: dateTime,
      note: note,
...
abstract class $RecordCopyWith<$Res> {
  ...
  $Res call({int weigth, DateTime dateTime, String? note});
}
...
class _$RecordCopyWithImpl<$Res> implements $RecordCopyWith<$Res> {
  ...
  @override
  $Res call({
    Object? weigth = freezed,
    Object? dateTime = freezed,
    Object? note = freezed,
  }) {
    return _then(_value.copyWith(
      weigth: weigth == freezed
          ? _value.weigth
...
class _$_Record implements _Record {
  _$_Record({required this.weigth, required this.dateTime, this.note});
  ...
  @override
  String toString() {
    return 'Record(weigth: $weigth, dateTime: $dateTime, note: $note)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other is _Record &&
            (identical(other.weigth, weigth) ||
                const DeepCollectionEquality().equals(other.weigth, weigth)) &&
  ...
  int get hashCode =>
      ...
      const DeepCollectionEquality().hash(weigth) ^
